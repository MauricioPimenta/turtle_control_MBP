...
class TurtleControl(Node):
    ...
    def init_subscribers(self):
        ...
        self.pose_subscriber_ = self.create_subscription(TurtlePose, self.sub_topic_turtle_Pose2D_name, self.pose_callback, 10)

        self.get_logger().info('Initializing goal subscriber: ' + self.sub_topic_goal_name)
        self.goal_subscriber_ = self.create_subscription(Pose, self.sub_topic_goal_name, self.goal_callback, 10)
    ...
    def init_publishers(self):
        ...
        self.timer_period = 1/self.controlFrequency
